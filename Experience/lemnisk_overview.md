  ...
  <div style="display: flex; align-items: center; gap: 2rem; margin-bottom: 2rem;">
    <div style="flex: 1;">
      ...
      <p style="margin: 0; opacity: 0.9; line-height: 1.5; font-size: 1.1rem;">
        Received recognition for <strong>outstanding contribution and dedication</strong> throughout this journey. This award reflects the impact of performance optimizations, system architecture improvements, and technical leadership contributions from internship to full-time role.
      </p>
    </div>
