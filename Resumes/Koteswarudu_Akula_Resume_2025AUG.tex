...
\begin{center}
    ...
    \large Backend Software Engineer | Java Spring Boot Specialist \\ \vspace{1pt}
...
\normalsize{
Backend Software Engineer with 2+ years of experience specializing in \textbf{Java Spring Boot} microservices and high-performance system architecture. Proven track record of delivering \textbf{30x performance improvements} and building scalable notification systems. Strong background in \textbf{CI/CD Devtron deployment pipelines}, production troubleshooting, and cross-platform SDK development. Recognized with \textbf{Lemnisk Spot Award Q1 2024} for outstanding technical contributions and system architecture leadership.
}
